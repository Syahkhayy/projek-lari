...
export const PACE_IMPROVEMENT = 13; // Seconds improved per valid run

// ─── Decay Rules (seconds added per inactive period) ───
export const DECAY_SMALL = 3;     // 3-4 days inactive
export const DECAY_MODERATE = 7;  // 5-7 days inactive
export const DECAY_HEAVY = 10;     // 8+ days inactive
